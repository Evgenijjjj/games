...
public class SNavigationDrawer extends RelativeLayout {
    ...
    private int appbarColor = R.color.transparent;
    private int appbarTitleTextColor = R.color.Black;
    private int menuItemSemiTransparentColor = R.color.transparent;
    ...
    public void init(Context context) {
        ...
        menuIV.setOnTouchListener(new OnTouchListener() {
            ColorFilter startColorFilter = menuIV.getColorFilter();
    ...
    protected void initMenu() {
        for (int i = 0; i < menuItemList.size(); i++) {
            ...
            backgroundCV.setOnClickListener(new OnClickListener() {
                @Override
            ...
            rootRL.setOnTouchListener(new OnTouchListener() {
                @Override
                public boolean onTouch(View v, MotionEvent event) {
                    if (currentPos != Integer.valueOf(v.getTag().toString())) {
                        switch (event.getAction()) {
                            case MotionEvent.ACTION_DOWN: {
                                v.setAlpha(0.5f);
                                break;
